...
def get_parameters():
    ...
    parser.add_argument('--save_path', type=str, default='./new_exp/temp_pems04_15/emb_64/', help='save path')
    parser.add_argument('--dataset', type=str, default='pems04', choices=['metr-la', 'pems-bay', 'pemsd7-m','pems03','pems04','pems08'])
...
def search_best_pth(path,metric = 'mae'):
    ...
    path = [p for p in path if int(p[:-4])>150]
